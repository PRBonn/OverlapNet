...
class featureExtracter(nn.Module):
    def __init__(self, height=64, width=900, channels=5, norm_layer=None):
        ...
        self.conv1 = nn.Conv2d(channels, 16, kernel_size=(5,15), stride=2, bias=False)
        ...
        self.conv6 = nn.Conv2d(128, 128, kernel_size=(1,9), stride=(2,1), bias=False)
        self.bn6 = norm_layer(128)
        self.conv7 = nn.Conv2d(128, 128, kernel_size=(1,9), stride=(2,1), bias=False)
        self.bn7 = norm_layer(128)
        self.conv8 = nn.Conv2d(128, 128, kernel_size=(1,9), stride=(2,1), bias=False)
        self.bn8 = norm_layer(128)
        self.conv9 = nn.Conv2d(128, 128, kernel_size=(1,7), stride=(2,1), bias=False)
        self.bn9 = norm_layer(128)
        self.conv10 = nn.Conv2d(128, 128, kernel_size=(1,5), stride=(2,1), bias=False)
        self.bn10 = norm_layer(128)
        self.conv11 = nn.Conv2d(128, 128, kernel_size=(1,3), stride=(2,1), bias=False)
        self.bn11 = norm_layer(128)
        self.relu = nn.ReLU(inplace=False)

        self.convLast = nn.Conv2d(128, 128, kernel_size=(1,1), stride=(1,1), bias=False)
