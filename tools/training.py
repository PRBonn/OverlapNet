    ...
    def train(self):
        ...
        for i in range(starting_epoch, epochs):
            ...
            for j in range(len(self.train_imgf1) // self.batch_size):
                ...
                print("epoch " + str(i) + " ---> " + "batch " + str(j) + "/" + str(len(self.train_imgf1) // self.batch_size) + " loss: ", loss)
            ...
            self.save_name = './amodel' + str(i) + '.pth.tar'
            ...
            print("Model Saved As " + 'amodel' + str(i) + '.pth.tar')
...
if __name__ == '__main__':
    ...
    train_handler = trainHandler(height=64, width=900, channels=num_channels, norm_layer=None, batch_size=2, lr=0.000001,
